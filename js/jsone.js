    ...
    245: function(t, e, i) {
        ...
        function HorizontalLayoutSlider(slider, t) {
            if (slider && slider.length) {
                var e = slider.children(".gallery-inner, .u-repeater");
                if (e.length) {
                    this.viewport = e;
                    var i = slider.children(".gallery-nav");
                    if (i.length) {
                        if (this.controls = i,
                        this.data = {
                            offset: 0,
        ...
        HorizontalLayoutSlider.prototype.updateControls = function() {
            ...
            this.controls.each((function() {
                var t = $(this)
                  , state = t.hasClass("gallery-nav-next") ? data.offset >= data.maxOffset - 1 : data.offset <= 0;
        ...
        HorizontalLayoutSlider.prototype.navigate = function(t) {
            if (!t.hasClass("u-hidden") && this.viewport) {
                ...
                if (t.hasClass("gallery-nav-next")) {
                    if (e = a(e + i) - 1,
 ...
 */
                ...
                if (t.is(".u-background-effect ~ .u-container-layout"))
                    ...
                    n(t.find(".u-back-image")).then((function(i) {
                        var n = t.siblings(".u-over-slide")
                          , o = t.closest(".gallery").is(".u-layout-thumbnails");
                        if (n.length && !o)
                            i.title = n.find(".gallery-heading").html(),
                            i.desc = n.find(".gallery-text").html();
                        e(i)
                    }
                    ), i);
                else
    ...
    8823: function(t, e, i) {
        "use strict";
        var n = t.exports = {};
        n.LIGHTBOX_SELECTOR = ".cursor",
        n.GALLERY_ITEM_SELECTOR = [".u-image:not(.u-carousel-thumbnail-image):not(.u-background-effect-image)", ".gallery-item", ".u-background-effect ~ .u-container-layout"].join(", "),
 ...
 */
    ...
    8847: function(t, e, i) {
        ...
        n(window).on("load", (function() {
            setTimeout((function() {
                n(".gallery").removeClass("shift"),
                n(".gallery-grid").each((function() {
                    var gallery = n(this)
                      , slider = new HorizontalLayoutSlider(gallery,true);
                    gallery.children(".gallery-nav").click((function(t) {
                        t.preventDefault();
        ...
        n((function() {
            var t;
            n("body").on("mouseenter", ".gallery.shift", (function() {
                n(this).closest(".gallery").removeClass("shift")
            }
            )),
            new o([".gallery.u-product-zoom.u-layout-thumbnails", ".gallery.u-product-zoom.u-layout-carousel"]).init()
        }
        ))
    },
    8848: function(t, e, i) {
        ...
        function o(t) {
            var e = t.currentTarget, i, n = u(e).closest(".gallery-item").data("zoom_click"), o = e.getBoundingClientRect(), a = e.querySelector("img"), s = t.clientX, l = t.clientY, f = t.originalEvent.changedTouches;
            if (!n && !f) {
                u(e).addClass("hover");
                var c = s - o.x
                  , h = l - o.y;
        ...
        function a(t) {
            ...
            u(e).closest(".gallery-item").data("zoom_click")
        }
        function s(t) {
